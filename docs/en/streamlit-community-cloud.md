...
The tracked bundle is `demo_artifacts/v1.0.1`. Build it from the local synthetic pipeline with:
...
5. Leave `RETAIL_DEMAND_ARTIFACT_DIRECTORY` unset to use `demo_artifacts/v1.0.1`, or set it to a
